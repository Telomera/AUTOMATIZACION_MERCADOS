...
d <- setDT(read.xlsx(paste0(path_input,"Agentes lipidicos Abril 24.xlsx"), sheet = 1))

d2 <- setDT(read.xlsx(paste0(path_input,"Agentes lipidicos Abril 24.xlsx"), sheet = 2))
...
# require(openxlsx)
# out_previo <- setDT(read.xlsx(paste0(path_input,"Agentes lipidicos Abril 24.xlsx"), sheet = 3))
#
# 
